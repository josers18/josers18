...
<!-- BLOG-POST-LIST:START -->- [First useful offline tasks](https://analyticsmadesimple.com/tutorials/first-useful-offline-open-model-tasks/) <sub>(Sep 17, 2026)</sub>- [Safety: random models on the internet](https://analyticsmadesimple.com/tutorials/open-models-safety-random-downloads/) <sub>(Sep 17, 2026)</sub>- [Sheets: formulas, cleanup, and explanations](https://analyticsmadesimple.com/tutorials/gemini-workspace-sheets-formulas-cleanup/) <sub>(Sep 17, 2026)</sub>- [One local stack end to end &lpar;Ollama-style&rpar;](https://analyticsmadesimple.com/tutorials/one-local-stack-ollama-style/) <sub>(Sep 16, 2026)</sub>- [Quality without benchmark theater](https://analyticsmadesimple.com/tutorials/open-models-quality-without-benchmark-theater/) <sub>(Sep 16, 2026)</sub><!-- BLOG-POST-LIST:END -->
