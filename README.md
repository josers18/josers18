...
<!-- BLOG-POST-LIST:START -->- [Friendly desktop runners from zero](https://analyticsmadesimple.com/tutorials/friendly-desktop-runners-from-zero/) <sub>(Sep 15, 2026)</sub>- [Privacy reasons normal people care](https://analyticsmadesimple.com/tutorials/open-models-privacy-reasons-normal-people/) <sub>(Sep 15, 2026)</sub>- [Jobs and AI: skills that still matter](https://analyticsmadesimple.com/tutorials/ai-safety-jobs-skills-that-still-matter/) <sub>(Sep 15, 2026)</sub>- [Grok Imagine rights, deepfakes, and common fails](https://analyticsmadesimple.com/tutorials/grok-imagine-rights-deepfakes-fails/) <sub>(Sep 15, 2026)</sub>- [Gmail: drafts, summaries, and tone with Gemini](https://analyticsmadesimple.com/tutorials/gemini-workspace-gmail-drafts-summaries-tone/) <sub>(Sep 15, 2026)</sub><!-- BLOG-POST-LIST:END -->
