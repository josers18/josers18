...
<!-- BLOG-POST-LIST:START -->- [Portfolio projects that do not look fake](https://analyticsmadesimple.com/analytics/portfolio-projects-that-do-not-look-fake/) <sub>(Aug 24, 2026)</sub>- [Building a personal learning plan: SQL to Python to AI](https://analyticsmadesimple.com/analytics/personal-learning-plan-sql-python-ai/) <sub>(Aug 24, 2026)</sub>- [Airflow hello: retries, sensors, and when not to use it](https://analyticsmadesimple.com/data-engineering/airflow-hello-retries-sensors/) <sub>(Aug 24, 2026)</sub>- [Churn and retention definitions that stick](https://analyticsmadesimple.com/analytics/churn-retention-definitions-that-stick/) <sub>(Aug 24, 2026)</sub>- [Access, least privilege, and just give me prod](https://analyticsmadesimple.com/data-management/access-least-privilege-just-give-me-prod/) <sub>(Aug 24, 2026)</sub><!-- BLOG-POST-LIST:END -->
