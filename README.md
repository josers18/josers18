...
<!-- BLOG-POST-LIST:START -->- [One local stack end to end &lpar;Ollama-style&rpar;](https://analyticsmadesimple.com/tutorials/one-local-stack-ollama-style/) <sub>(Sep 16, 2026)</sub>- [Quality without benchmark theater](https://analyticsmadesimple.com/tutorials/open-models-quality-without-benchmark-theater/) <sub>(Sep 16, 2026)</sub>- [Docs: outline to draft with control](https://analyticsmadesimple.com/tutorials/gemini-workspace-docs-outline-draft-control/) <sub>(Sep 16, 2026)</sub>- [Friendly desktop runners from zero](https://analyticsmadesimple.com/tutorials/friendly-desktop-runners-from-zero/) <sub>(Sep 15, 2026)</sub>- [Privacy reasons normal people care](https://analyticsmadesimple.com/tutorials/open-models-privacy-reasons-normal-people/) <sub>(Sep 15, 2026)</sub><!-- BLOG-POST-LIST:END -->
