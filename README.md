...
<!-- BLOG-POST-LIST:START -->- [Scams, deepfakes, and too-good offers](https://analyticsmadesimple.com/tutorials/ai-safety-scams-deepfakes-too-good-offers/) <sub>(Sep 08, 2026)</sub>- [Give context, constraints, and examples](https://analyticsmadesimple.com/tutorials/prompting-context-constraints-examples/) <sub>(Sep 08, 2026)</sub>- [Personal vs work accounts &lpar;and why it matters&rpar;](https://analyticsmadesimple.com/tutorials/ai-setup-personal-vs-work-accounts/) <sub>(Sep 08, 2026)</sub>- [Grok Build project loop: explore, change, check](https://analyticsmadesimple.com/tutorials/grok-build-explore-change-check/) <sub>(Sep 08, 2026)</sub>- [Gemini CLI and Antigravity CLI &lpar;what replaced what&rpar;](https://analyticsmadesimple.com/tutorials/gemini-product-map-cli-antigravity-transition/) <sub>(Sep 08, 2026)</sub><!-- BLOG-POST-LIST:END -->
