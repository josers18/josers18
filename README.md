...
<!-- BLOG-POST-LIST:START -->- [Gemini in Android Studio and Code Assist](https://analyticsmadesimple.com/tutorials/gemini-product-map-android-studio-code-assist/) <sub>(Sep 07, 2026)</sub>- [Browser vs mobile vs desktop apps](https://analyticsmadesimple.com/tutorials/ai-setup-browser-vs-mobile-vs-desktop/) <sub>(Sep 06, 2026)</sub>- [A/B tests intuition for analysts](https://analyticsmadesimple.com/analytics/ab-tests-intuition-for-analysts/) <sub>(Sep 06, 2026)</sub>- [AI for documentation and data dictionaries](https://analyticsmadesimple.com/tutorials/ai-for-documentation-and-data-dictionaries/) <sub>(Sep 06, 2026)</sub>- [Grok at home, school, and work: four realistic weeks](https://analyticsmadesimple.com/tutorials/grok-family-school-work-examples/) <sub>(Sep 06, 2026)</sub><!-- BLOG-POST-LIST:END -->
