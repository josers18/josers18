...
<!-- BLOG-POST-LIST:START -->- [First week of useful tasks &lpar;write, plan, learn&rpar;](https://analyticsmadesimple.com/tutorials/chatgpt-first-week-useful-tasks/) <sub>(Aug 06, 2026)</sub>- [Models chooser: Haiku, Sonnet, Opus, and Fable &lpar;no hype&rpar;](https://analyticsmadesimple.com/tutorials/claude-models-chooser-haiku-sonnet-opus-fable/) <sub>(Aug 06, 2026)</sub>- [Joins and merges in plain English](https://analyticsmadesimple.com/analytics/pandas-joins-and-merges/) <sub>(Aug 06, 2026)</sub>- [API and builders’ tools &lpar;light&rpar;](https://analyticsmadesimple.com/tutorials/chatgpt-api-and-builders-tools-light/) <sub>(Aug 05, 2026)</sub>- [Claude Design and Claude Science &lpar;where they fit&rpar;](https://analyticsmadesimple.com/tutorials/claude-design-and-claude-science/) <sub>(Aug 05, 2026)</sub><!-- BLOG-POST-LIST:END -->
