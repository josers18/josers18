...
<!-- BLOG-POST-LIST:START -->- [Chat vs agent vs work mode vs coding agent](https://analyticsmadesimple.com/tutorials/chat-vs-agent-vs-work-mode-vs-coding-agent/) <sub>(Sep 10, 2026)</sub>- [Study, work email, plans, and shopping research](https://analyticsmadesimple.com/tutorials/prompting-study-email-plans-shopping/) <sub>(Sep 10, 2026)</sub>- [Files, uploads, and where your data goes](https://analyticsmadesimple.com/tutorials/ai-setup-files-uploads-where-data-goes/) <sub>(Sep 10, 2026)</sub>- [Grok Build for sheets and research &lpar;carefully&rpar;](https://analyticsmadesimple.com/tutorials/grok-build-sheets-research-carefully/) <sub>(Sep 10, 2026)</sub>- [Models chooser without hype](https://analyticsmadesimple.com/tutorials/gemini-product-map-models-chooser-without-hype/) <sub>(Sep 10, 2026)</sub><!-- BLOG-POST-LIST:END -->
